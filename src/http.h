...
enum class HttpVerb { GET = 0, HEAD, POST, PUT, DELETE, CONNECT, OPTIONS, TRACE };

enum class RouteVerb { INVALID = 0, GET, POST, PUT, DELETE, CONNECT, OPTIONS, TRACE, ANY, WEBSOCKET };
