...
public:
    SavepointRevertFsmTransition(FsmTransition*&& delegate) : DelegatingFsmTransition(std::move(delegate)) {
    }
...
public:
    DiscardFsmTransition(FsmTransition*&& delegate) : DelegatingFsmTransition(std::move(delegate)) {
    }
...
public:
    PushFsmTransition(FsmTransition*&& delegate) : DelegatingFsmTransition(std::move(delegate)) {
    }
...
public:
    SkipFsmTransition(FsmTransition*&& delegate) : DelegatingFsmTransition(std::move(delegate)) {
    }
...
public:
    FinalFsmTransition(size_t finalState) : finalState(finalState) {
    }
...
public:
    OrFinalFsmTransition(FsmTransition*&& delegate) : DelegatingFsmTransition(std::move(delegate)) {
    }
