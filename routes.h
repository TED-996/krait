...
public:
	...
	bool isDefaultTarget() {return targetFilename == "$default$";}
	
	std::string getTarget() {return targetFilename;}
...
Route& getRouteMatch(std::vector<Route> routes, HttpVerb verb, std::string url, std::map<std::string, std::string>& outParams);
